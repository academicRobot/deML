...
// do not clean up previous returns, required for multithreading
//	delete(toreturn);
//    }
	...
	toreturn=new FastQObj(new string(currentline1), new string(currentline2), new string(currentline4), isFasta);
    }
    return true;
}
